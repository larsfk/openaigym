...
def step(state, i, counter):
    ...
    q_learning(action, reward, state, observation, counter)
...
def episode(i):
    ...
    while counter < MAX_STEPS:
        state, reward, done = step(state, i, counter)
...
def q_learning(a, r, s, ns, counter):  # ns = next state
    if r == 1:
